...
```{r 4a4 tracts per county state summary, message=F, warning=F, cache=T, eval=T, fig.width=20}
...
```{r 4b2 Compare OZ and Non-OZ-LIC pt1,  message=F, warning=F, cache=T, eval=T, fig.width=20}
...
```{r 4b3 Compare OZ and Non-OZ-LIC pt1, message=F, warning=F, cache=T, eval=T, fig.width=20}
...
```{r 4b4 Compare OZ and Non-OZ-LIC pt1, message=F, warning=F, cache=T, eval=T, fig.width=20}
...
```{r 4c Compare OZ and Non-OZ-LIC pt2,  message=F, warning=F, cache=T, eval=T, fig.width=20}
...
```{r 5 generate maps, message=F, warning=F, cache=T, eval=T, fig.height=50}
